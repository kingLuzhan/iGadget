	...
	public String create_cart(HttpServletRequest req, HttpServletResponse res, PrintWriter pw) {
		...
		try {
			...
			t = t + "<div class='row pull-right text-primary' style='font-size:25px;font-weight:bold'>Grand total: <i class='fa fa-rupee'></i>"
					+ total + "/-</div>";
			t = t + "<br/><div class='row pull-left'><a href='payment.jsp?emailid=" + emailid + "&mobile=" + mobile
					+ "&fname=" + fname + "&grandtotal=" + total
					+ "'id='btn_checkout' class='btn btn-primary' style='width:100%'><i class='fa fa-credit-card'></i> Make Payment</a></div>";
