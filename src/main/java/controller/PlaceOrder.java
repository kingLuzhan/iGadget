...
public class PlaceOrder extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		bno = c.get(Calendar.YEAR) + "" + c.get(Calendar.MONTH) + "" + c.get(Calendar.DAY_OF_MONTH) + ""
		...
		try {
			...
			while (e.hasMoreElements()) {
				...
				if (n.charAt(0) == 'P') {
					...
					t = t + "<div class='col-md-1 col-md-offset-1' text-right' ><div style='font-size: 16px;font-weight:bold;font-family:monospace;padding-bottom:10px'><i class='fa fa-rupee'></i>"
							+ rs1.getString("price") + "/-</div></div>";
					t = t + "<div class='col-md-1 col-md-offset-1' style='padding-right:0px;'><div style='font-size: 18px;color:palevioletred;font-weight:bold;font-family:monospace;padding-bottom:10px'><i class='fa fa-rupee'></i>"
			...
			t1 = t1 + "</table>";
			t = t + "<br/><div class='row pull-right text-primary' style='font-size:25px;font-weight:bold'>Grand total: <i class='fa fa-rupee'></i>"
					+ total + "/-</div>";
			...
			String m = "<h2> Satish Interiors </h2> <div style='color:blue'> Customer name: " + fname
					+ "</div><br/>Your Order is confirmed and details are as follows:<br/><b>Booking ID:</b>" + bno
					+ "<br/>" + "<br/><b>Product details:<br/><br/></b>" + t1
					+ "<br/><div style='color:blue'>Grand Total:" + total + "/-<br/>Payment mode:" + mode + "</div>";
