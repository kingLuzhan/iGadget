			...
			if (rs1.next()) {
				...
				do {
					...
					t = t + "<td style='padding-left:40px'>"
							+ "<button id='btn_delete' type='button' class='fa fa-trash-o' style='border:none;font-size:20px;color:#ff3333;background-color: #d9edf7;'></i></button>";
					t = t + "<td >" + "<a href='modifyproduct.jsp?pcode=" + rs1.getString(1)
							+ "'  type='button' class='btn btn-info'>Modify</a></tr>";
					i++;
				} while (rs1.next());
				pw.println(t);
			} else {
