		...
		try {
			...
			if (rs1.next()) {
				...
				t = t + "<img src='GetProductImage?pcode=" + rs1.getString("pcode")
						+ "'style='width:100%;height:200px' alt='Offer 1' class='img-responsive'></img></div></div></div>";

				t = t + "<div class='col-md-3'><div style='font-size: 25px;font-family:monospace;'>"
						+ rs1.getString("pname") + "</div>";

				t = t + "<div style='font-size: 25px;color:palevioletred;font-weight:bold;font-family:monospace;padding-top:10px;padding-bottom:10px'><i class='fa fa-rupee'></i>"
						+ rs1.getString("price") + "/-</div>";
				t = t + "<div>Availability: <div style='font-family:monospace;font-size: 18px;color:green;'>In stock</div></div>";
				t = t + "<div style='font-size: 20px;font-weight:lighter;padding-top:3px;'>Quick Overview</div> <div style='font-size: 15px'>"
						+ rs1.getString("description") + "</div><div style='padding-top:3px;padding-bottom:10px'>Type:"
